...
class BuyHouseCrawlerSuumo
  ...
  def self.detail_crawl
    ...
    CSV.open("buy_house_suumo.csv", "w") do |csv|
      header = ['name', 'address', 'access', 'madori', 'strong_point', 'prefecture_name', 'price', 'zip_code', 'hours', 'age', 'land_area', 'house_area', 'built_time', 'notes', 'recommendation', 'shop_id', 'source', 'image_url1', 'image_url2', 'image_url3', 'image_url4', 'built_date']
      csv << header
